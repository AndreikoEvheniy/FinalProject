...
public class RemoveWorkerCommand extends Command {
    private static final Logger LOG = Logger.getLogger(RemoveWorkerCommand.class);
    DBManager dbManager;
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response)
        ...
        dbManager.removeWorker(workerId);
        LOG.trace("Remove worker by id: --> " + workerId);
