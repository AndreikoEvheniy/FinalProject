...
/**
 * Sorting button by name command.
 *
 * @author E.Andreiko
 */

public class SortingButtonsByName extends Command {

    private static final Logger LOG = Logger.getLogger(SortingButtonsByName.class);
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response)
        ...
        Comparator<Flights> comparator = Comparator.comparing(Flights::getName);
